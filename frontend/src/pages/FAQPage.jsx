...
export default function FAQPage() {
    ...
    const { faqVideos } = educationalContent;
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <motion.div className="mb-12" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
                    <div className="flex items-center justify-between mb-4">
                        <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-600 to-orange-600 dark:from-yellow-400 dark:to-orange-400">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg">
                        Find answers to common questions about the app, AI accuracy, privacy, and skin health.
                    </p>
                </motion.div>
